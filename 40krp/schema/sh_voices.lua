...
Schema.voices.Add("Humanoid", "Grito de guerra", "*Suelta un alarido de guerra.*", "vo/guard/lobo2.wav")
Schema.voices.Add("Humanoid", "Guerra", "¡GUERRAAAAAAAAA!", "vo/guard/lobo1.wav")
Schema.voices.Add("Humanoid", "Gusanos", "¡Voy a acabar con vosotros, malditos gusanos!", "vo/guard/lobo3.wav")
Schema.voices.Add("Humanoid", "FyH", "¡Fuerza y honor!", "vo/guard/lobo4.wav")
Schema.voices.Add("Humanoid", "honor", "¡HONOOOOOR! ¡HONOOOOOOOR!", "vo/guard/lobo5.wav")